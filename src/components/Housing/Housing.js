    ...
    <Container className='rounded my-5 cus-font cont px-3'>
      <Row className='d-flex'>
        ...
        <Col className='fire rounded col-sm-12 col-md-5'>
          ...
          <Button className='mx-3 mb-3' target='_blank' variant='orange' href='https://hamren-housing.up.railway.app/'><span className="fire"><FontAwesomeIcon icon={faHouse} /> Visit</span></Button>
          <Button className="mx-3 mb-3" target='_blank' variant='orange' href='https://github.com/TheHamhams/housing-flask'><span className='fire'><FontAwesomeIcon icon={faGithub} /> Flask</span></Button>
          <Button className='mx-3 mb-3' target='_blank' variant='orange' href='https://www.kaggle.com/code/coreyhamren/housing-prices-top-1/notebook'><span className='fire'><FontAwesomeIcon icon={faKaggle} /> Kaggle</span></Button>
        </Col>
