        ...
        <Container className='rounded my-5 cus-font cont px-5'>
          <Row className='d-flex'>
            ...
            <Col className='fire rounded col-5'>
              ...
              <br/>
              <Button className='mx-5' target='_blank' variant='orange' href='https://mastermind-production.up.railway.app/'><span className='fire'><FontAwesomeIcon icon={faLock} /> Visit</span></Button>
              <Button className='mx-5' target='_blank' variant='orange' href='https://github.com/TheHamhams/mastermind'><span className='fire'><FontAwesomeIcon icon={faGithub} /> Flask</span></Button>
            </Col>
